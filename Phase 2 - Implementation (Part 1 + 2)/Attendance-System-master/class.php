...
<html>
 <head>
  ...
  <style>
      .form-control{display:inline-block !important; width: 185px !important; margin:5px !important;}
      .details{padding:5px 10px;margin-bottom:30px;border: 1px solid lightgrey;border-top: none;}
  </style>
 </head>
 <body>
  <div id="header" class="clearfix">
    <h1>Goverment Polytechnic Jamnagar</h1>
    <h3>Edit Class</h3>	
  </div>
