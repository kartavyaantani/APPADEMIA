<?php
  session_start();
  $isIndex = 1;
  if(array_key_exists('teacher_id',$_SESSION) && isset($_SESSION['teacher_id']) == 6 ) {
   header('Location: admin.php');
  }
  elseif (array_key_exists('teacher_id',$_SESSION) && isset($_SESSION['teacher_id'])) {
...
<li class="u-nav-item"><a class="u-button-style u-nav-link" href="About-US.html">About US</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="/aqpg/Attendance-System-master/index.php">Attendance System</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="/aqpg/">Examination System</a>
        ...
        <a href="Main.html" class="u-border-2 u-border-grey-75 u-btn u-button-style u-custom-color-5 u-hover-feature u-hover-palette-2-light-2 u-radius-50 u-text-hover-palette-5-dark-1 u-btn-1">APPADEMIA</a>
        <a href="Main.html" class="u-image u-logo u-image-1" data-image-width="687" data-image-height="687">
          <img src="/aqpg/Site1/images/FINALLL.png" class="u-logo-image u-logo-image-1">
        </a>
  <div class="container">
    <h2>For Students</h2>
